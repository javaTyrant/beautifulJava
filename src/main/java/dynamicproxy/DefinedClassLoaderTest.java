...
public class DefinedClassLoaderTest extends ClassLoader {
    ...
    protected Class<?> loadClass(String name, boolean resolve)
        ...
        synchronized (getClassLoadingLock(name)) {
            ...
            if (c == null) {
                 ...
                 */
                if (!name.startsWith("dynamicproxy.Demo")) {
    ...
    public static void main(String[] args) throws Exception {
        DefinedClassLoaderTest classLoader = new DefinedClassLoaderTest("/Users/lumac/work/beautifulCode/src/main/java/");
        Class<?> clazz = classLoader.loadClass("dynamicproxy.Demo");
        Object obj = clazz.newInstance();
        Method sout = clazz.getDeclaredMethod("say", null);
